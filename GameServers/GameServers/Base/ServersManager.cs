using GameServers.Module.Game.Net;
using System;
...
namespace GameServers.Base {
	...
	class ServersManager {
		...
		public ServersManager() {
			...
			IPAddress iPAddress = IPAddress.Parse("192.168.118.6");
			IPEndPoint iPEndPoint = new IPEndPoint(iPAddress, 10002);
			try {
				serverSocket.Bind(iPEndPoint);
				Console.WriteLine("GameServers，启动！");
